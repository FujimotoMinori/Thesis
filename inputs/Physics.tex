...
\end{equation}
where a and b are summed over all partonic constituents of the colliding hadrons, $h_1$ and $h_2$, respectively.
...
\hline
\hline \multirow{3}{*}{ Full-leptonic }      & ssWW -> lvlv     & $6.5~(4.4^{\mathrm{Sherpa}}, 6.5^{\mathrm{Powheg}})~\sigma$ (36.1~$fb^{-1}$) & $5.5~(5.7)~\sigma$ (35.9~$fb^{-1}$)  \\
\cline { 2 - 4 }                             & osWW             & $-$                                & $-$   \\
\cline { 2 - 4 }                             & WZ -> lvll       & $5.3~(3.2)~\sigma$ (36.1~$fb^{-1}$) & $2.2~(2.5)~\sigma$ (35.9~$fb^{-1}$)   \\
\cline { 2 - 4 }                             & ZZ -> llll/llvv  & $5.5~(4.3)~\sigma$ (139~$fb^{-1}$)  & $2.7~(1.6)~\sigma$ (35.9~$fb^{-1}$) (only llll) \\
\hline \multicolumn{2}{|c|}{ Semi-leptonic }                    & $2.7~(2.5)~\sigma$ (36.1~$fb^{-1}$)~\cite{STDM-2017-20} & 4.4~$\sigma$~(139~$fb^{-1}$)(only 1-lep)~\cite{CMS-SMP-20-013}  \\
...
In this thesis, semi-leptonic channel is studied. One weak vector boson (W or Z) decays into leptons ( electrons or muons or neutrino) and the other decays into hadrons.
The first measurement of this channel in ATLAS using $35.5~fb^{-1}$ of the Run~2 dataset with a significance of 2.7~$\sigma$~\cite{STDM-2017-20}. CMS has published a measurement of 4.4~$\sigma$ using only the 1-lepton channel~\cite{CMS-SMP-20-013}.

The advantage of the semi-leptonic VBS final states is its hi
...
%Supersymmetric model or extra-dimensional models like Randall-Sundrum gravity~\cit{} can also be the example 
%Any model that affect to the Higgs sector may be observed as the deviation of the VBS scattering amplitude with the existence of anomalous gauge couplings (aGC).  
...
\end{equation}
where the second term represents the dimension-6 operators which affect triple gauge couplings (TGC) and quartic couplings (QGC), and the third term represents the dimension-8 operators, which affect only quartic couplings.
