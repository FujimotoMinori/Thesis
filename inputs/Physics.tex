...
The PDF is estimated by the collision data from previous and current experiments and extrapolated to the appropriate energy using the so-called DGLAP evolution equations.\cite{}.
