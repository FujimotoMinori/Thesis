...
As illustrated in Figure~\ref{fig:factorization}, the total cross section of the process can be factorized in a long-distance part in the left part of the figure, and a short-distance part illustrated in the right.
