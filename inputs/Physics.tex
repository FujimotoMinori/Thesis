...
The parton shower does the splittings of the outgoing colored partons.  The MC simulations are based on the Markov chain, in which the components of the hard subprocess are evolved by adding branchings of one parton into two partons, in the limit of the infrared cutoff scale, t$_{\mathrm{cutoff}}$, typically $t_{0} \approx 1~\mathrm{GeV}$. 
...
Pythia and Herwig adopt different phenomenological models: String Model~\cite{ANDERSSON198331}, based on the linear confinement of partons, and the Cluster Model~\cite{MARCHESINI19841}, based on the preconfinement of parton showers.
