...
%
The estimated QCD scale uncertainties with Z+jets background and the EW VV+jj signal in the 2-lepton channels are shown in figure~\ref{fig:QCDZ} and \ref{fig:QCDSig}, respectively.
\begin{figure}[H]
\begin{center}
