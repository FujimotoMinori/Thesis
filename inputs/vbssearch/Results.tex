...
The fiducial cross section defined in section~\ref{sec:crosssection} is derived using the observed $\mu$ value.
The expected cross section derived truth event selection using the stable final state particle is shown in table~\ref{tab:}.
