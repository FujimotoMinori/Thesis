...
The following ``left-side" bins of the SR discriminant distribution are referred to as the bins in the SR that contains 25~\% of the signal sample.
%RNN modeling check
...
Overall the post-fit RNN distributions in the CRs show good background modeling except for the right-most bin of the one-lepton channel, which indicates that the RNN score discriminant has good modeling with all NPs. For the 2-lepton channel, the discrepancy seen in figure~\ref{fig:after_rw} as a slope is well corrected.
