...
\section{Several check of the design of the fitting and the background modeling}
\label{sec:confirm}
...
%    \centering
%    %2lep
%    \includegraphics[width=0.45\textwidth]{figures/PostFit/}
%    \includegraphics[width=0.45\textwidth]{figures/PostFit/}
%    \includegraphics[width=0.45\textwidth]{figures/PostFit/}
%    \caption{Comparisons of the observed data and expected background distributions of $m^{tag}_{jj}$ in 2-lepton channel signal regions. The EW VV+jj signal is filled on top of the fitted backgrounds, normalized to the signal yield extracted from the observed data ($\mu = 0.98$). The bottom panel shows the ratio of the observed data to the post fit signal and background predictions.}
...
The fiducial cross section defined in section~\ref{sec:crosssection},$\sigma_{EWVVjj,\mathrm{obs}}$, is derived using the observed $\mu$ value.
...
The expected cross section is a sum of the each cross section of each lepton channel. 
...
\hline$\sigma_{EWVVjj,\mathrm{SM}}$ & 0-lepton & 1-lepton & 2-lepton \\ \hline 
Merged                              & $1.4 $   & $2.8 $   & $0.7 $   \\  \hline 
Resolved                            & $1.7 $   & $4.3 $   & $1.5 $   \\ \hline
Combined                            & $3.1 $   & $7.1 $   & $2.1 $   \\ \hline
                                    & \multicolumn{3}{*}{ $12.4 $ }  \\ \hline
\end{tabular}
...
Combined                            & $3.1 $   & $7.1 $   & $2.1 $   \\ \hline
                                    & \multicolumn{3}{*}{ $12.4 $ }  \\ \hline
\end{tabular}
\caption{\label{tab:obsxsec} A summary of predicted fiducial cross section }
\end{center}
\end{table}
