...
The expected cross-section from the standard model prediction, $\sigma_{EW VVjj \mathrm{, \ SM}}$ can be exploited by using the truth event yields, yields after applying the fiducial selections, and the luminosity.
