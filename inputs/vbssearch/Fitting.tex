...
\end{center}
\end{table}
In the signal regions the RNN score is used, while in the CRs the $m^{tag}_{jj}$ is employed in order to give better constraints to the $m^{tag}_{jj}$ reweighting uncertainty. 
