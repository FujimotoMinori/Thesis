...
The signal selection efficiencies after applying all the selections in those tables are shown in the table~\ref{tab:selectioneff}.
...
\begin{figure}[H]
    ...
    \begin{tabular}{|c||c|c|c|}
         \hline
                        & Resolved SR  & Merged HP SR & Merged LP SR \\ \hline
        0-lepton        &  1.4~\%  &   0.6~\% &    0.5~\%               \\ \hline
        1-lepton        &  1.3~\%  &   0.4~\% &    0.6~\%               \\ \hline
        2-lepton        &  2.1~\%  &   0.4~\% &    0.3~\%               \\ \hline
    \end{tabular}
        }
...
\begin{figure}[H]
    ...
    \begin{tabular}{|c||c|c|c|}
         \hline
                        & Resolved SR  & Merged HP SR & Merged LP SR \\ \hline
        0-lepton        &  1.0~\%  &   2.6~\% &    1.0~\%            \\ \hline
        1-lepton        &  0.9~\%  &   1.9~\% &    1.1~\%            \\ \hline
        2-lepton        &  0.5~\%  &   2.7~\% &    0.8~\%             \\ \hline
    \end{tabular}
        }
