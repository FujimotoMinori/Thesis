...
The leading jet is required to have $p_\mathrm{T} > 40~\mathrm{GeV}$ and the subleading, $p_\mathrm{T} > 20~\mathrm{GeV}$. Their invariant mass (m$^{sig}_{jj}$) should be inside the mass window of 64 < $m_^{sig}_{jj}$ < 106~GeV, near the W/Z mass. Figure~\ref{fig:MVHadResSR} shows that the reconstructed boson peak before requiring the mass window.
