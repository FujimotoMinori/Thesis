...
\begin{figure}[ht]
    \begin{center}
        \subfigure[$\text{top mass peak}$]{\includegraphics[width=0.4\textwidth]{figures/2lep/topMass/WZjjtopMasspeak}}
        \subfigure[$\text{top mass in CRVjet}$]{\includegraphics[width=0.4\textwidth]{figures/2lep/dataMC/C_0ptag2pjet_0ptv_CRVjet_topMass_Log}}
