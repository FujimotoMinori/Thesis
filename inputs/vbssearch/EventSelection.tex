...
First the preselection cuts are applied including basic event cleaning and the trigger selections, then the specific event selection is applied to the each 0,1,2-lepton channels.
