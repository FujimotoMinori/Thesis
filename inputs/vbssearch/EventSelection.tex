...
The event selection has been optimized to identify the phase space which enhances the signal with respect to the background.
...
For the main event selection, first the selection of the $W/Z$ boson decaying leptonically is selected. 
