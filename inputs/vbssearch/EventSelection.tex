...
Figure~\ref{} shows the $m^{tag}_{jj}$ distribution before selecting the SR or CR. 
\begin{figure}[ht]
    \centering
...
\begin{figure}[ht]
    ...
    \includegraphics[width=0.4\textwidth]{figures/2lep/dataMC/C_0ptag1pfat0pjet_0ptv_ALL_el2Pt_Log} 
    \includegraphics[width=0.4\textwidth]{figures/2lep/dataMC/C_0ptag1pfat0pjet_0ptv_ALL_mu1Pt_Log}
    \caption{mass of the large-R jet distribution before and after applying the boson tagger.}
