...
The comparison of distributions of data and MC for the number of small-R jets and $p_T$ of the two forward jets, and the RNN score after reweighting are shown in Figure \ref{fig:after_rw}
