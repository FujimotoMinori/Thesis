...
\begin{figure}[ht]
    \centering
    \subfigure[$m_{VV}$ distribution in Merged HP Signal region]{\includegraphics[width=0.45\textwidth]{figures/aQGC/MllJ_SR_HP_aQGC.pdf}}
    \subfigure[$m_{VV}$ distribution in Merged LP Signal region]{\includegraphics[width=0.45\textwidth]{figures/aQGC/MllJ_SR_LP_aQGC.pdf}}
...
\begin{figure}[ht]
    \centering
    \subfigure[RNN score distribution in Merged HP Signal region]{\includegraphics[width=0.45\textwidth]{figures/aQGC/RNNScoreMerged_SR_HP_aQGC.pdf}}
    \subfigure[RNN score distribution in Merged LP Signal region]{\includegraphics[width=0.45\textwidth]{figures/aQGC/RNNScoreMerged_SR_LP_aQGC.pdf}}
...
\begin{figure}[ht]
    \centering
    	\subfigure[ FT0 term ]{\includegraphics[width=0.30\textwidth]{figures/aQGC/HPSRFT0MVV.pdf}}
    	\subfigure[ FS02 term]{\includegraphics[width=0.30\textwidth]{figures/aQGC/HPSRFS02MVV.pdf}}
    	\subfigure[ FM0 term ]{\includegraphics[width=0.30\textwidth]{figures/aQGC/HPSRFM0MVV.pdf}}
...
\begin{figure}[ht]
    \centering
    	\subfigure[ FT0 term ]{\includegraphics[width=0.30\textwidth]{figures/aQGC/HPSRFT0RNN.pdf}}
    	\subfigure[ FS02 term]{\includegraphics[width=0.30\textwidth]{figures/aQGC/HPSRFS02RNN.pdf}}
    	\subfigure[ FM0 term ]{\includegraphics[width=0.30\textwidth]{figures/aQGC/HPSRFM0RNN.pdf}}
...
\begin{figure}[ht]
    \centering
    	\subfigure[ 0lep merged CR ]{\includegraphics[width=0.35\textwidth]{figures/aQGC/Region_distMTagJets_DCRVjetMer_BMin0_J0_incJet1_L0_T0_incFat1_Y6051_incTag1_Fat1_Prefitlog.pdf}}
    	\subfigure[ 0lep HP SR ]{\includegraphics[width=0.35\textwidth]{figures/aQGC/Region_distMtvvJ_DSRVBSHP_BMin0_J0_incJet1_L0_T0_incFat1_Y6051_incTag1_Fat1_Prefitlog.pdf}}
    	\subfigure[ 0lep LP SR ]{\includegraphics[width=0.35\textwidth]{figures/aQGC/Region_distMtvvJ_DSRVBSLP_BMin0_J0_incJet1_L0_T0_incFat1_Y6051_incTag1_Fat1_Prefitlog.pdf}}
    	\subfigure[ 0lep resolved CR ]{\includegraphics[width=0.35\textwidth]{figures/aQGC/Region_distMTagResJets_DCRVjetFid_BMin0_T0_Y6051_incTag1_J2_L2_incJet1_Prefitlog.pdf}}
    	\subfigure[ 0lep resolved SR ]{\includegraphics[width=0.35\textwidth]{figures/aQGC/Region_distMtvvJ_DSRVBSHP_BMin0_J0_incJet1_L0_T0_incFat1_Y6051_incTag1_Fat1_Prefitlog.pdf}}
...
\begin{figure}[ht]
    \centering
    	\subfigure[ 1lep merged Vjet CR ]{\includegraphics[width=0.35\textwidth]{figures/aQGC/Region_disttagMjj_DCRVjetMerged_BMin0_J0_incJet1_L1_T0_incFat1_Y6051_incTag1_Fat1_Prefitlog.pdf}}
    	\subfigure[ 1lep HP Top CR ]{\includegraphics[width=0.35\textwidth]{figures/aQGC/Region_disttagMjj_DCRTopHP_BMin0_J0_incJet1_L1_T0_incFat1_Y6051_incTag1_Fat1_Prefitlog.pdf}}
    	\subfigure[ 1lep LP Top CR ]{\includegraphics[width=0.35\textwidth]{figures/aQGC/Region_disttagMjj_DCRTopLP_BMin0_J0_incJet1_L1_T0_incFat1_Y6051_incTag1_Fat1_Prefitlog.pdf}}
    	\subfigure[ 1lep HP SR ]{\includegraphics[width=0.35\textwidth]{figures/aQGC/Region_distMVV_DSRVBSHP_BMin0_J0_incJet1_L1_T0_incFat1_Y6051_incTag1_Fat1_Prefitlog.pdf}}
    	\subfigure[ 1lep LP SR ]{\includegraphics[width=0.35\textwidth]{figures/aQGC/Region_distMVV_DSRVBSLP_BMin0_J0_incJet1_L1_T0_incFat1_Y6051_incTag1_Fat1_Prefitlog.pdf}}
    	\subfigure[ 1lep resolved Vjet CR ]{\includegraphics[width=0.35\textwidth]{figures/aQGC/Region_disttagMjj_DCRVjetTight_BMin0_T0_Y6051_incTag1_J2_L1_incJet1_Prefitlog.pdf}}
    	\subfigure[ 1lep resolved Top CR ]{\includegraphics[width=0.35\textwidth]{figures/aQGC/Region_disttagMjj_DCRTopTight_BMin0_T0_Y6051_incTag1_J2_L1_incJet1_Prefitlog.pdf}}
    	\subfigure[ 1lep resolved SR ]{\includegraphics[width=0.35\textwidth]{figures/aQGC/Region_distMVV_DSRVBSTight_BMin0_T0_Y6051_incTag1_J2_L1_incJet1_Prefitlog.pdf}}
...
\begin{figure}[ht]
    \centering
    	\subfigure[ 2lep merged CR ]{\includegraphics[width=0.35\textwidth]{figures/aQGC/Region_distMTagMerJets_DCRVjet_BMin0_J0_incJet1_L2_T0_incFat1_Y6051_incTag1_Fat1_Prefitlog.pdf}}
    	\subfigure[ 2lep HP SR ]{\includegraphics[width=0.35\textwidth]{figures/aQGC/Region_distMllJ_DSRVBSHP_BMin0_J0_incJet1_L2_T0_incFat1_Y6051_incTag1_Fat1_Prefitlog.pdf}}
    	\subfigure[ 2lep LP SR ]{\includegraphics[width=0.35\textwidth]{figures/aQGC/Region_distMllJ_DSRVBSLP_BMin0_J0_incJet1_L2_T0_incFat1_Y6051_incTag1_Fat1_Prefitlog.pdf}}
    	\subfigure[ 2lep resolved CR ]{\includegraphics[width=0.35\textwidth]{figures/aQGC/Region_distMTagJets_DCRVjetFid_BMin0_T0_Y6051_incTag1_J2_L0_incJet1_Prefitlog.pdf}}
    	\subfigure[ 2lep resolved SR ]{\includegraphics[width=0.35\textwidth]{figures/aQGC/Region_distMtvvjj_DSRVBSFid_BMin0_T0_Y6051_incTag1_J2_L0_incJet1_Prefitlog.pdf}}
...
\begin{figure}[ht]
    \centering
    	\subfigure[ 2lep merged CR ]{\includegraphics[width=0.35\textwidth]{figures/aQGC/Region_distMTagMerJets_DCRVjet_BMin0_J0_incJet1_L2_T0_incFat1_Y6051_incTag1_Fat1_Prefitlog.pdf}}
    	\subfigure[ 2lep HP LowMVV SR ]{\includegraphics[width=0.35\textwidth]{figures/aQGC/Region_distRNNScoreMerged_DSRVBSHPLMVV_BMin0_J0_incJet1_L2_T0_incFat1_Y6051_incTag1_Fat1_Prefit.pdf}}
    	\subfigure[ 2lep HP HighMVV SR ]{\includegraphics[width=0.35\textwidth]{figures/aQGC/Region_distRNNScoreMerged_DSRVBSHPHMVV_BMin0_J0_incJet1_L2_T0_incFat1_Y6051_incTag1_Fat1_Prefit.pdf}}
    	\subfigure[ 2lep LP LowMVV SR ]{\includegraphics[width=0.35\textwidth]{figures/aQGC/Region_distRNNScoreMerged_DSRVBSLPLMVV_BMin0_J0_incJet1_L2_T0_incFat1_Y6051_incTag1_Fat1_Prefit.pdf}}
    	\subfigure[ 2lep LP HighMVV SR ]{\includegraphics[width=0.35\textwidth]{figures/aQGC/Region_distRNNScoreMerged_DSRVBSLPHMVV_BMin0_J0_incJet1_L2_T0_incFat1_Y6051_incTag1_Fat1_Prefit.pdf}}
...
\begin{figure}[ht]
    \centering
    	\subfigure[ FT0 ]{\includegraphics[width=0.35\textwidth]{figures/aQGC/ClippedFT0.pdf}}
    	\subfigure[ FT1 ]{\includegraphics[width=0.35\textwidth]{figures/aQGC/ClippedFT1.pdf}}
    	\subfigure[ FT2 ]{\includegraphics[width=0.35\textwidth]{figures/aQGC/ClippedFT2.pdf}}
...
\begin{figure}[ht]
    \centering
    	\subfigure[ FT5 ]{\includegraphics[width=0.35\textwidth]{figures/aQGC/ClippedFT5.pdf}}
    	\subfigure[ FT6 ]{\includegraphics[width=0.35\textwidth]{figures/aQGC/ClippedFT6.pdf}}
    	\subfigure[ FT7 ]{\includegraphics[width=0.35\textwidth]{figures/aQGC/ClippedFT7.pdf}}
        \caption{Expected limits for 5 clipping points are shown for each coefficient FT5, FT6, and FT7.}
\end{figure}

\begin{figure}[ht]
    \centering
    	\subfigure[ FT8 ]{\includegraphics[width=0.35\textwidth]{figures/aQGC/ClippedFT8.pdf}}
    	\subfigure[ FT9 ]{\includegraphics[width=0.35\textwidth]{figures/aQGC/ClippedFT9.pdf}}
    	\subfigure[ FM0 ]{\includegraphics[width=0.35\textwidth]{figures/aQGC/ClippedFM0.pdf}}
        \caption{Expected limits for 5 clipping points are shown for each coefficient FT8, FT9, and FM0.}
\end{figure}

\begin{figure}[ht]
    \centering
    	\subfigure[ FM1 ]{\includegraphics[width=0.35\textwidth]{figures/aQGC/ClippedFM1.pdf}}
    	\subfigure[ FM2 ]{\includegraphics[width=0.35\textwidth]{figures/aQGC/ClippedFM2.pdf}}
    	\subfigure[ FM3 ]{\includegraphics[width=0.35\textwidth]{figures/aQGC/ClippedFM3.pdf}}
        \caption{Expected limits for 5 clipping points are shown for each coefficient FM1, FM2, and FM3.}
\end{figure}

\begin{figure}[ht]
    \centering
    	\subfigure[ FM4 ]{\includegraphics[width=0.35\textwidth]{figures/aQGC/ClippedFM4.pdf}}
    	\subfigure[ FM5 ]{\includegraphics[width=0.35\textwidth]{figures/aQGC/ClippedFM5.pdf}}
    	\subfigure[ FM7 ]{\includegraphics[width=0.35\textwidth]{figures/aQGC/ClippedFM7.pdf}}
        \caption{Expected limits for 5 clipping points are shown for each coefficient FT4, FT5, and FM7.}
\end{figure}

\begin{figure}[ht]
    \centering
    	\subfigure[ FS02 ]{\includegraphics[width=0.35\textwidth]{figures/aQGC/ClippedFS02.pdf}}
    	\subfigure[ FS1 ]{\includegraphics[width=0.35\textwidth]{figures/aQGC/ClippedFS1.pdf}}
