...
The log-likelihood (-2 ln $\lambda$) distributions with respect to the signal strength of aQGC signal, $\mu_{aQGC}$, is shown in figure~\ref{} for FT0 operator, for each clipping energy of 1500~GeV, 2000~GeV, 3000~GeV, $\infty$.
